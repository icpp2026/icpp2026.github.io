...
We welcome proposals for workshops on new, innovative topics as well as submissions to continue successful workshops from previous years. Note that proceedings of ICPP workshops will be published by the ACM in dedicated proceedings. The selected workshops will be held on the first day of the conference (28 September).

## Important Dates (AoE)

- **April 10:** Workshops proposals' deadline
- **April 17:** Notification of acceptance
- **TBA:** Paper Submission deadline
- **TBA:** Notification of acceptance (Papers)
- **July 30:** Camera-ready due (based on conference camera ready deadline)

## Workshops Submission Process

**To Submit:** Please email your proposal to the Workshops chairs using the following addresses: [lofsteadjaywork@gmail.com](mailto:lofsteadjaywork@gmail.com), [chen-quan@sjtu.edu.cn](mailto:chen-quan@sjtu.edu.cn). The submissions must conform to the Submission Guidelines.
...
- **Relevance to ICPP:** Highlight how the proposed workshop complements the main conference program.
