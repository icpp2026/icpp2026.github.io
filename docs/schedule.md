...
ICPP 2026 takes place **September 28 - October 1, 2026**. Workshops and tutorials are held on
Monday, September 28; the main conference runs Tuesday, September 29 through Thursday, October 1.
...
| [**Tue, 29 Sep**](#day-1) — Main Conference Day 1 | Opening · Keynotes 1–2 · Sessions 1A–2D · Posters & Demos · Reception |
| [**Wed, 30 Sep**](#day-2) — Main Conference Day 2 | Keynotes 3–4 · Sessions 3A–4D · Banquet |
| [**Thu, 1 Oct**](#day-3) — Main Conference Day 3 | Sessions 5A–8D |

----

## Monday, September 28 — Workshops and Tutorials { #day-0 }
...
## Tuesday, September 29 — Main Conference Day 1 { #day-1 }
...
## Wednesday, September 30 — Main Conference Day 2 { #day-2 }
...
## Thursday, October 1 — Main Conference Day 3 { #day-3 }
...
### Session 1A — MoE Systems { #session-1a }
...
### Session 1B — Disaggregated Memory { #session-1b }
...
### Session 1C — Scientific Computing I { #session-1c }
...
### Session 1D — Compiler Optimization { #session-1d }
...
### Session 2A — LLM Inference and Serving I { #session-2a }
...
### Session 2B — Processing-in-Memory { #session-2b }
...
### Session 2C — Numerical Computing { #session-2c }
...
2. **From 2<sup>N</sup> to N<sup>2</sup>: Tree-Free Scalable Sparse Symmetric Tucker Decomposition**  
...
### Session 2D — Graph Algorithms { #session-2d }
...
### Session 3A — LLM Inference and Serving II { #session-3a }
...
### Session 3B — Key-Value Stores { #session-3b }
...
### Session 3C — Hardware Acceleration { #session-3c }
...
### Session 3D — Graph Learning { #session-3d }
...
### Session 4A — LLM Inference and Serving III { #session-4a }
...
### Session 4B — Storage Systems { #session-4b }
...
### Session 4C — Sparse Linear Algebra I { #session-4c }
...
### Session 4D — Performance Analysis and Modeling I { #session-4d }
...
### Session 5A — Memory Management { #session-5a }
...
### Session 5B — AI Acceleration { #session-5b }
...
### Session 5C — Serverless Computing { #session-5c }
...
### Session 5D — Parallel Data Processing { #session-5d }
...
### Session 6A — AI Caching { #session-6a }
...
### Session 6B — Learning-Based Scheduling { #session-6b }
...
### Session 6C — Network Algorithms { #session-6c }
...
### Session 7A — Sparse Linear Algebra II { #session-7a }
...
### Session 7B — Data-Center Networks { #session-7b }
...
### Session 7C — Distributed Learning { #session-7c }
...
### Session 7D — Parallel Training { #session-7d }
...
### Session 8A — GEMM Optimization { #session-8a }
...
### Session 8B — Cloud Scheduling { #session-8b }
...
### Session 8C — Federated Learning { #session-8c }
...
### Session 8D — Scientific Computing II { #session-8d }
